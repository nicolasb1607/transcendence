...
import { BlackHole } from '../objects/BlackHole.service';

@Injectable()
export class SpatialPong {
	...
	constructor(gameData: GameData) {
		...
		this.ball = new Ball(
			...
			this.gameLogic, GameType.spatialPong, this.gameData
		);

		this.blackhole[0] = new BlackHole(15);
		this.blackhole[1] = new BlackHole(15);

		this.collision = new Collision(
			this.pads, this.blackhole, this.ball, this.gameLogic,
			GameType.spatialPong
		);
